...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/YS_BOTZ_UPDATE)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/Raadhe_Krishnn>🔹YS Botz☢</a></b>
  
 <b>✯ Join here : <a href=https://t.me/YS_BOT_DISSCUSION>🔹Join my updateds☢</a></b> 
 ...
 ./song - Download any song [<code>example /song ram siya ram</code>] 
 ...
 ./video - This command usage any YouTube video download hd [<code>example /video https://youtu.be/Xyz123etc-k</code>]

./font - This command usage stylish and cool font generator [<code>example /font YS movie</code>]"""
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ {} Gʀᴏᴜᴘ ❤️\nᴡᴇ ᴀʀᴇ ɴᴏᴛʜɪɴɢ ᴡɪᴛʜᴏᴜᴛ ʏᴏᴜ ᴘʟᴇᴀsᴇ sʜᴀʀᴇ ᴜs ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ғᴏʀ ᴍᴏʀᴇ\nᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ʟɪɴᴋ - https://t.me/YS_Movvies</b>"""
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
ᴡɪᴛʜᴏᴜᴛ ᴊᴏɪɴɪɴɢ ᴄʜᴀɴɴᴇʟ ʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇ ᴀɴᴅ ᴜᴘᴅᴀᴛᴇ ᴀʙᴏᴜᴛ ʙᴏᴛ"""
...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 ᴜꜱᴀɢᴇ: /telegraph - ꜱᴇɴᴅ ᴍᴇ ᴘɪᴄᴛᴜʀᴇ ᴏʀ ᴠɪᴅᴇo ᴜɴᴅᴇʀ (5ᴍʙ) 
  
 ɴᴏᴛᴇ: 
 ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ɪꜱ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ɢʀᴏᴜᴘ ᴀɴᴅ ᴘᴍꜱ 
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த Mr.Argon .ோட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this Mr.Argon to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ Mr.Argon ాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस Mr.Argon को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ Mr.Argon.ോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس Mr.Argon وٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ Mr.Argon ટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ Mr.Argon ಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই Mr.Argon ট পরিচালনা করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/Raadhe_Krishnn'>YS BOTZ 🇮🇳</a>

-Dev 2 <a href='https://t.me/YS_Contact_RoBot'>YS Contact</a>

-Dev 3 <a href='https://t.me/YS_Movvies>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ </> TɢX</a>

- Dev 4 <a href='https://t.me/YS_BOTZ_UPDATE'>UPDATE</a>
"""
    PREMIUM_TXT = """<b>ᴊᴏɪɴ ᴀ ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ ᴛᴏ ɢᴇᴛ ғʀᴇᴇ ᴍᴏᴠɪᴇ ᴡɪᴛʜᴏᴜᴛ ᴀɴʏ ᴀᴅs
ʏᴏᴜʀ ᴛɪᴍᴇ ɪs ᴠᴀʟᴜᴀʙʟᴇ, sᴛᴏᴘ ᴡᴀᴛᴄʜɪɴɢ ᴀᴅs ᴀɴᴅ sɪᴍᴘʟʏ ᴀᴠᴏɪᴅ ᴛʜᴇ sᴛᴜᴘɪᴅɪᴛʏ \n\nʙᴜʏ ᴘʀᴇᴍɪᴜᴍ ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss ᴛᴏ ᴇᴠᴇʀʏ ᴍᴏᴠɪᴇ ɪɴ ᴡᴏʀʟᴅ ᴍᴏᴠɪᴇ ɪɴ ғᴇᴡ ʀᴜᴘᴘᴇs.\nᴅᴏɴ'ᴛ ᴛʜɪɴᴋ ᴛᴏ ᴍᴜᴄʜ ɪ ᴀᴍ ᴛʀᴜsᴛᴇᴅ ʙᴜʏ ɪᴛ. 
</a>

ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀsʜɪᴘ ᴘʀɪᴄᴇs

𝟷 ᴍᴏɴᴛʜ - 𝟸𝟶 ʀs [𝟽 ᴅᴀʏs ғʀᴇᴇ ᴛʀɪᴀʟ]

𝟹 ᴍᴏɴᴛʜs – 𝟾𝟶 ʀs [𝟷𝟻 ᴅᴀʏs ғʀᴇᴇ ᴛʀɪᴀʟ]

𝟼 ᴍᴏɴᴛʜs - 𝟷𝟻𝟶 ʀs [𝟷 ᴍᴏɴᴛʜ ғʀᴇᴇ ᴛʀɪᴀʟ]

𝟷𝟸 ᴍᴏɴᴛʜs - 𝟸𝟾𝟶 ʀs [𝟸 ᴍᴏɴᴛʜ ғʀᴇᴇ ᴛʀɪᴀʟ]

ʟɪғᴇᴛɪᴍᴇ - 𝟹𝟻𝟶 ʀs [ʙᴇsᴛ ᴘʟᴀɴ]

ᴄᴜsᴛᴏᴍ ᴘʟᴀɴ  - ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴏᴡɴᴇʀ

ʙʀᴏᴛʜᴇʀ/sɪsᴛᴇʀ ᴅᴏɴ'ᴛ ᴛʜɪɴᴋ ᴛᴏ ᴍᴜᴄʜ ᴛʜᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ɪs 𝟿𝟶% ʟᴇss ᴛʜᴀɴ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴏғ ɴᴇᴛғʟɪx, ᴀᴍᴀᴢᴏɴ ᴘʀɪᴍᴇ & ᴇᴛᴄ. 

ᴜᴘɪ ɪᴅ »»————> ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴏᴡɴᴡᴇʀ

♛ ᴘᴀʏᴍᴇɴᴛ »»————> ɪғ ᴡʜᴏ ᴡᴀɴᴛ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ᴅɪʀᴇᴄᴛ
ᴡᴏᴜʟᴅ ʏᴏᴜ ʟɪᴋᴇ ᴛᴏ ʙᴇᴄᴏᴍᴇ ᴀ ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀ? ғᴏʟʟᴏᴡ ᴛʜᴇsᴇ sᴛᴇᴘs:-

✤ sᴛᴇᴘ 𝟷: ɢᴏ ᴛᴏ ᴀɴʏ ᴘᴀʏᴍᴇɴᴛ ᴀᴘᴘ ʟɪᴋᴇ ɢᴏᴏɢʟᴇ ᴘᴀʏ, ᴘᴀʏᴛᴍ,
✤ sᴛᴇᴘ 𝟸: ᴘᴀʏ ᴜsɪɴɢ ᴜᴘɪ ɪᴅ ᴅᴇᴘᴇɴᴅɪɴɢ ᴏɴ ʏᴏᴜʀ ᴘʟᴀɴ.
✤ sᴛᴇᴘ 𝟹 : sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴛᴏ ᴏᴜʀ ᴀᴅᴍɪɴ ᴏʀ ᴏᴡɴᴇʀ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ᴛᴏ sᴇɴᴅ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ.

ᴛᴏ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴄʟɪᴄᴋ ᴏɴ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ⬇⬇ ʙᴜᴛᴛᴏɴ

𝕵𝖆𝖎 𝕾𝖍𝖗𝖊𝖊 𝕽𝖆𝖒 | 🙏ℜ𝔞𝔡𝔥𝔢 𝔎𝔯𝔦𝔰𝔥𝔫𝔞

𝗡𝗼𝘁𝗲 - 𝗗𝗼𝗻'𝘁 𝗰𝗼𝗺𝗲 𝗳𝗼𝗿 𝘄𝗮𝘀𝘁𝗶𝗻𝗴 𝘆𝗼𝘂𝗿 𝗮𝗻𝗱 𝗺𝘆 𝘁𝗶𝗺𝗲 𝗴𝘂𝘆𝘀 𝗶𝘁 𝗶𝘀 𝗽𝗿𝗲𝗰𝗶𝗼𝘂𝘀..

ᴀɴʏ ᴅᴏᴜʙᴛs ᴏʀ ʜᴏᴡ ᴛᴏ ʙᴇᴄᴏᴍᴇ ᴀ ᴘʀɪᴍᴇ ᴍᴇᴍʙᴇʀ? ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ <a href='https://t.me/Raadhe_Krishnn'>𝙊𝙬𝙣𝙚𝙧</a></code></b>"""
